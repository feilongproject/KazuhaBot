// 各等级精通基础伤害
export const eleBaseDmg: { [level: number]: number } = {
    1: 20,
    2: 22,
    3: 23,
    4: 24,
...
export const eleMap: { [weaponEn: string]: string } = {
    anemo: '风',
    cryo: '冰',
    electro: '雷',
    geo: '岩',
...
// 元素反应类型及基数
// 暂无需考虑碎冰
export const erType: { [type: string]: any } = {
    zf: { type: 'pct', num: ({ element }: any) => element === '水' ? 2 : 1.5 },
    rh: { type: 'pct', num: ({ element }: any) => element === '火' ? 2 : 1.5 },
...
export const attrMap: {
    [key: string]: {
        type: string, val: number, title: string, text: string;
    }
} = {
